            ...
            rep(i3, 7) {
                ...
                rep(i5, 5) {
                    ...
                    rep(i7, 4) {
                        rui11 = 1;
                        rep(i11, 4) {
                            ll t = rui2 * rui3 * rui5 * rui7 * rui11;
                            if (t == 1) {
                                continue;
                            }
                            t *= b;
