...
/* ------------------------------------- */
ll a[200020], b[200020], c[200020], d[200020], e[200020], f[200020];
ll n, m, q;
ll x[200020], y[200020];
...
signed main() {
    ...
    rep(i, q) {
        ...
        ll retx = a[at] * x[bt] + b[at] * y[bt] + e[at];
        ll rety = c[at] * x[bt] + d[at] * y[bt] + f[at];
        printf("%lld %lld\n", retx, rety);
    }
